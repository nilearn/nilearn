...
def test_show_dmtx():
    ...
    DM = make_dmtx(frame_times, drift_model='polynomial', drift_order=3)
    ax = DM.show()
...
def test_dmtx0():
    ...
    X, names= dmtx_light(frame_times, drift_model='polynomial',
                            drift_order=3)
...
def test_dmtx1():
    ...
    hrf_model = 'Canonical'
    X, names= dmtx_light(frame_times, paradigm,  hrf_model=hrf_model,
...
def test_dmtx20():
    ...
    paradigm = modulated_event_paradigm()
    X, names = dmtx_light(frame_times, paradigm, hrf_model='canonical',
        drift_model='cosine')
...
def test_fir_block():
    ...
    tr = 1.0
    frame_times = np.linspace(0, 127 * tr, 128)
    X, names = dmtx_light(frame_times, bp, hrf_model='fir', drift_model='blank',
...
def test_csv_io():
    ...
    frame_times = np.linspace(0, 127 * tr, 128)
    paradigm = modulated_event_paradigm()
    DM = make_dmtx(frame_times, paradigm, hrf_model='Canonical',
                   drift_model='polynomial', drift_order=3)
    path = 'dmtx.csv'
...
def test_spm_1():
    ...
    paradigm =  EventRelatedParadigm(conditions, onsets)
    X1 = make_dmtx(frame_times, paradigm, drift_model='blank')
    spm_dmtx = DMTX['arr_0']
