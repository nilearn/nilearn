...
Here, we will go through a full step-by-step example of fitting a GLM to experimental data and visualizing
...
# Here, we compare the activation mas produced from each session separately and then the fixed effects version.
