...
1. First, ensure that you have installed Sphinx and sphinx-gallery
...
5. Once you are happy with the html outputs in ``nilearn/doc/_build/html/auto_examples/``, you are good to submit the PR!
