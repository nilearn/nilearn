...
def test_mean_img(images_to_mean, tmp_path):
    ...
    # Test with files
    imgs = testing.write_tmp_imgs(*images_to_mean, file_path=tmp_path)
...
def test_iter_img(tmp_path):
    ...
    img_4d_filename = testing.write_tmp_imgs(img_4d, file_path=tmp_path)
    ...
    img_3d_filenames = testing.write_tmp_imgs(*img_3d_list, file_path=tmp_path)
