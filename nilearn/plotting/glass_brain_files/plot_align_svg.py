...
#                                         title='anat', alpha=1)
# display = img_plotting.plot_glass_brain(bg_img, threshold=0, black_bg=True,
#                                         title='anat', alpha=1, display_mode='ortho')
# display = img_plotting.plot_glass_brain(bg_img, threshold=0,
#                                         title='anat', alpha=1)

# checking hemispheres plotting
# display = img_plotting.plot_glass_brain(bg_img, threshold=0, black_bg=True,
#                                         title='anat', alpha=1, display_mode='r')
# display = img_plotting.plot_glass_brain(bg_img, threshold=0, black_bg=True,
#                                         title='anat', alpha=1, display_mode='l')
# display = img_plotting.plot_glass_brain(bg_img, threshold=0, black_bg=True,
#                                         title='anat', alpha=1, display_mode='lr')
display = img_plotting.plot_glass_brain(bg_img, threshold=0, black_bg=True,
                                        title='anat', alpha=1, display_mode='lyrz')
