...
class BaseSlicer:
    ...
    _default_figsize: ClassVar[tuple[float, float]] = (2.2, 2.6)
    _axes_class = CutAxes
...
class OrthoSlicer(BaseSlicer):
    ...
    _axes_class = CutAxes
    _default_figsize: ClassVar[tuple[float, float]] = (2.2, 3.5)
...
class ZSlicer(BaseStackedSlicer):
    ...
    _default_figsize: ClassVar[tuple[float, float]] = (2.2, 3.2)
