...
def test_get_colorbar_and_data_ranges_symmetric_cbar_true(
    ...
    """Test for _get_colorbar_and_data_ranges with symmetric colorbar."""
...
def test_get_colorbar_and_data_ranges_symmetric_cbar_false_pos_neg(
    ...
    """
    Test for _get_colorbar_and_data_ranges with non-symmetric colorbar.
...
def test_get_colorbar_and_data_ranges_masked(
    ...
    """Test for _get_colorbar_and_data_ranges with masked data."""
    assert expected_results == _get_colorbar_and_data_ranges(
        data_masked,
        vmin=vmin,
        vmax=vmax,
