...
@pytest.mark.parametrize(
    ...
    [
        ...
        (-3, 5, 0.5, 5, [-3, -0.5, 0, 0.5, 3, 5]),
        (-3, 5, 0.5, 6, [-3, -0.5, 0, 0.5, 1.8, 3.4, 5]),
        (-3, 5, 0.5, 7, [-3, -1.7, -0.5, 0, 0.5, 2.3, 3.7, 5]),
        (-3, 5, 1.5, 7, [-3, -1.5, 0, 1.5, 2.3, 3.7, 5]),
        (-5, 10, 0.5, 5, [-5, -1.2, -0.5, 0, 0.5, 2.5, 6.2, 10]),
        (-5, 10, 2.5, 5, [-5, -2.5, 0, 2.5, 6.25, 10]),
        (-5, 3, 0.5, 5, [-5, -3, -0.5, 0, 0.5, 3]),
        (-5, 3, 0.5, 6, [-5, -3.4, -1.8, -0.5, 0, 0.5, 3]),
        (-5, 3, 0.5, 7, [-5, -3.7, -2.3, -0.5, 0, 0.5, 1.7, 3]),
        (-3, 4, 5, 5, [-5, -3, 0, 4, 5]),
