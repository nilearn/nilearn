...
@pytest.mark.parametrize(
    ...
    [
        ...
        (-3, 5, 0.5, 6, [-3, -0.5, 0.5, 1.8, 3.4, 5]),
        (-3, 5, 0.5, 7, [-3, -1.7, -0.5, 0.5, 2.3, 3.7, 5]),
        (-3, 5, 1.5, 7, [-3, -1.5, -0.33, 1.5, 2.3, 3.7, 5]),
        (-5, 10, 0.5, 5, [-5, -1.2, -0.5, 0.5, 2.5, 6.2, 10]),
        (-5, 10, 2.5, 5, [-5, -2.5, 2.5, 6.25, 10]),
        (-5, 3, 0.5, 5, [-5, -3, -0.5, 0.5, 3]),
        (-5, 3, 0.5, 6, [-5, -3.4, -1.8, -0.5, 0.5, 3]),
        (-5, 3, 0.5, 7, [-5, -3.7, -2.3, -0.5, 0.5, 1.7, 3]),
        (-3, 4, 5, 5, [-5, -3, -1.2, 0.5, 2.2, 4, 5]),
        (-3, 5, 3.5, 5, [-3.5, -3, -1, 1, 3.5, 5]),
        (-5, 5, 0.5, 5, [-5, -2.5, -0.5, 0, 0.5, 2.5, 5]),
        (-5, 5, 2.5, 6, [-5, -2.5, -1, 1, 2.5, 5]),
        (-10, 10, 0.1, 5, [-10, -5, -0.1, 0, 0.1, 5, 10]),
        (-10, 10, 0.9, 5, [-10, -5, -0.9, 0, 0.9, 5, 10]),
        (-10, 10, 1.3, 5, [-10, -5, -1.3, 0, 1.3, 5, 10]),
        (-10, 10, 2.5, 5, [-10, -5, -2.5, 0, 2.5, 5, 10]),
        (-10, 10, 3.5, 5, [-10, -3.5, 0, 3.5, 10]),
        (-10, 10, 7.5, 5, [-10, -7.5, -5, 0, 5, 7.5, 10]),
    ],
)
