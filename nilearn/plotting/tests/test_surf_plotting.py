...
@pytest.mark.skipif(_is_plotly_installed(),
...
@pytest.mark.skipif(not _is_plotly_installed() or _is_kaleido_installed(),
...
@pytest.mark.skipif(not _is_plotly_installed() or not _is_kaleido_installed(),
...
@pytest.mark.skipif(not _is_plotly_installed() or not IPYTHON_INSTALLED,
...
def test_plot_surf(engine, tmp_path):
    if not _is_plotly_installed() and engine == "plotly":
