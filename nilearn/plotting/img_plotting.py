...
from scipy import cluster, ndimage, sparse, stats
...
@fill_doc
def plot_carpet(img, mask_img=None, mask_labels=None, t_r=None, ordering=None,
    ...
    The ordering comes from :footcite:`AQUINO2020`.
