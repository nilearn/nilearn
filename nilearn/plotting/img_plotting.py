...
def show():
    """Show all the figures generated by nilearnn and/or matplotlib.
...
def _plot_img_with_bg(
    ...
    **kwargs,
    ...
    kwargs:  extra keyword arguments, optional
        ...
        :meth:`~nilearnn.plotting.displays.BaseSlicer.add_overlay`.

    Returns
    -------
    display : :class:`~nilearnn.plotting.displays.OrthoSlicer` or \
        :class:`~nilearnn.plotting.displays.OrthoProjector` or None
...
def plot_img(
    ...
    **kwargs,
    ...
    .. seealso::
        ...
        :func:`~nilearnn.plotting.plot_anat`
            To simply plot anatomical images
        :func:`~nilearnn.plotting.plot_epi`
            To simply plot raw EPI images
        :func:`~nilearnn.plotting.plot_roi`
            To simply plot max-prob atlases (3D images)
        :func:`~nilearnn.plotting.plot_prob_atlas`
            To simply plot probabilistic atlases (4D images)
        :mod:`nilearnn.plotting`
...
class _MNI152Template(SpatialImage):
    """Constant pointing to the MNI152 Template provided by nilearnn."""
...
def plot_anat(
    ...
    **kwargs,
    ...
    anat_img : Niimg-like object, default=MNI152TEMPLATE
        ...
        given, nilearnn tries to find a T1 template.
    %(cut_coords)s
    %(output_file)s
    %(display_mode)s
    %(figure)s
...
def _plot_roi_contours(display, roi_img, cmap, alpha, linewidths):
    ...
    Parameters
    ----------
    display : nilearnn.plotting.displays.OrthoSlicer, object
...
def plot_roi(
    ...
    **kwargs,
    ...
    See Also
    --------
    nilearnn.plotting.plot_prob_atlas : To simply plot probabilistic atlases
        (4D images)
...
def plot_prob_atlas(
    ...
    **kwargs,
    ...
    See Also
    --------
    nilearnn.plotting.plot_roi : To simply plot max-prob atlases (3D images)
...
def plot_stat_map(
    ...
    **kwargs,
    ...
    See Also
    --------
    nilearnn.plotting.plot_anat : To simply plot anatomical images
    nilearnn.plotting.plot_epi : To simply plot raw EPI images
    nilearnn.plotting.plot_glass_brain : To plot maps in a glass brain
...
def plot_connectome(
    ...
    See Also
    --------
    nilearnn.plotting.find_parcellation_cut_coords : Extraction of node
        coords on brain parcellations.
    nilearnn.plotting.find_probabilistic_atlas_cut_coords : Extraction of
