...
def fetch_haxby(data_dir=None, n_subjects=None, subjects=[2, ],
    ...
    n_subjects: int, optional
        ...
        NOTE: n_subjects is deprecated from 0.2.5.1 and will be removed in 0.3
        Use `subjects` instead.

    subjects : int or list, optional
        Number of subjects or specific list of subjects to load. If None is
        provided all 6 subjects (maximum) will be loaded. By default, 2nd
        subject will be loaded.
    ...
    if n_subjects is not None:
        warnings.warn("The parameter 'n_subjects' is deprecated from 0.2.5.1 "
