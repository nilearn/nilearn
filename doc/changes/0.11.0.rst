...
-   Single hemisphere meshes can be instantiated with
    :class:`~nilearn.surface.SurfaceMesh`, :class:`~nilearn.surface.InMemoryMesh` or :class:`~nilearn.surface.FileMesh`.
    :class:`~nilearn.surface.SurfaceMesh`
