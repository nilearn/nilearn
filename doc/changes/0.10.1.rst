...
- :bdg-danger:`Deprecation` Add correct "zscore_sample" strategy to ``signal.standardize`` which will replace the default "zscore" strategy in release 0.13  (:gh:`3474` by `Yasmin Mzayek`_).
