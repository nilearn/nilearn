...
.. _v0-2-0-new-features:

New features
------------

- :bdg-success:`API` The new module :mod:`~nilearn.connectome` now has class :class:`~connectome.ConnectivityMeasure` can be useful for computing functional connectivity matrices.
...
- :bdg-dark:`Code` The function ``nilearn.connectome.sym_to_vec`` in same module :mod:`~nilearn.connectome` is also implemented as a helper function to class :class:`~connectome.ConnectivityMeasure`.
