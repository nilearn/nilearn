...
- :bdg-secondary:`Maint` Refactors fmriprep confound loading such that the parsing of the relevant image file and the loading of the confounds are done in separate steps (:gh:`3274` by `David G Ellis`_).
