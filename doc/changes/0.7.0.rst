...
- Nilearn now includes the functionality of `Nistats <https://nistats.github.io>`_ as :mod:`nilearn.glm`. This module is experimental, hence subject to change in any future release. `Here's a guide to replacing Nistats imports to work in Nilearn. <nistats_migration>` (:gh:`2299`, :gh:`2304`, and :gh:`2307` by `Kshitij Chawla`_, and :gh:`2509` by `Binh Nguyen`_).
...
- Nilearn now includes the functionality of `Nistats <https://nistats.github.io>`_.
  `Here's a guide to replacing Nistats imports to work in Nilearn. <nistats_migration>`
- New decoder object
