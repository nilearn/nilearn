...
- :bdg-danger:`Deprecation` The function :func:`~glm.save_glm_to_bids` was moved to the :mod:`~glm` module. It will be importable from its original :mod:`~interfaces` till Nilearn version 0.15.0 (:gh:`5770` by `Rémi Gau`_).
