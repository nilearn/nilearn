...
It is now also possible to perform cluter thresholding and cluster level inference on surface data.
...
- :bdg-success:`API` Add a :class:`~maskers.MultiSurfaceMasker`, a :class:`~maskers.MultiSurfaceLabelsMasker` and a a :class:`~maskers.MultiSurfaceMapsMasker` (:gh:`5679`, :gh:`5726`, :gh:`5727`  by `Rémi Gau`_).
