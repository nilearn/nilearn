...
- :bdg-primary:`Doc` Add ``Examples`` docstring sections for an utility function in the public API: :func:`~nilearn.image.threshold_img` (:gh:`6280` by `Fernanda Ponce`_).
