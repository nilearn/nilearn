...
- :bdg-success:`API` Add support for ``cluster_threshold`` for :func:`~image.threshold_img`, :func:`~glm.threshold_stats_img`, :func:`~reporting.make_glm_report`, :meth:`~glm.first_level.FirstLevelModel.generated_report` and :meth:`~glm.second_level.SecondLevelModel.generated_report` (:gh:`5715` by `Rémi Gau`_).
