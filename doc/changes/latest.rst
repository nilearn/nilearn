...
- :bdg-success:`API` :class:`~nilearn.utils.InputTags` and :func:`~nilearn.utils.get_tag` are now part of the public API in :mod:`nilearn.utils`, so that third-party estimators can declare whether they accept Nifti and / or surface images (:gh:`6563` by `Aniket Singh Yadav`_).
