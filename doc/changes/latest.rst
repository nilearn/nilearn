...
- Function :func:`~glm.second_level.second_level._check_second_level_input` now raises an error when `flm_object` argument is False and `second_level_input` is a list (:gh:`3283` by `Matthieu Joulot`_).
