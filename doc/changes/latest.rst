...
- :bdg-dark:`Code` Make sure that all atlases and datasets fetchers return a description. :func:`~datasets.fetch_language_localizer_demo_dataset` and  :func:`~datasets.fetch_bids_langloc_dataset`. (:gh:`4215` `Rémi Gau`_)
