...
- :bdg-dark:`Code` Add surface support for :func:`~nilearn.image.clean_img`, :func:`~nilearn.image.new_img_like`, :func:`~nilearn.image.index_img`, :func:`~nilearn.image.mean_img`, :func:`~nilearn.image.concat_imgs`, :func:`~nilearn.image.iter_img`,
:func:`~nilearn.image.threshold_img` (:gh:`4999`, :gh:`5425`, :gh:`5224`, :gh:`5301` by `Rémi Gau`_).
...
- :bdg-danger:`Deprecation` Add a ``nilearn.plotting.img_plotting.plot_img_comparison`` was moved to :func:`~nilearn.plotting.img_comparison.plot_img_comparison` (:gh:`5120` by `Rémi Gau`_).
