...
# taken from
# https://github.com/sphinx-gallery/sphinx-gallery/blob/c12c0e7da2c639e17f8ef3d36416ef968e9c310a/sphinx_gallery/gen_rst.py#L1442
header = """
.. DO NOT EDIT.
...
# hack to inject a link to binder in the header of each example
# note this will only link to the latest stable version of the example
# and not the one on main
# https://github.com/sphinx-gallery/sphinx-gallery/blob/c12c0e7da2c639e17f8ef3d36416ef968e9c310a/sphinx_gallery/gen_rst.py#L1583
class Header(str):
    """Override string to inject proper URL."""

    def format(self, example_fname, ref_fname, interactive_example_text):
        """Override string formatting to inject proper URL."""
        tmp = super().format(
            self, example_fname, ref_fname, interactive_example_text
        )

        binder_url = (
            "https://mybinder.org/v2/gh/nilearn/nilearn/"
            f"{latest_release}?urlpath=lab/tree/notebooks/"
            f"{example_fname.replace('.py', '.ipynb')}"
        )
...
.. note::
    ...
    You can view an interactive version of this example in Binder
