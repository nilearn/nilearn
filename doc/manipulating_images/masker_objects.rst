...
a resting-state dataset with :func:`fetch_development_rsfmri()
<nilearn.datasets.fetch_development_rsfmri>`, restrict it to 100 frames and
...
.. literalinclude:: ../../examples/04_manipulating_images/plot_mask_computation.py
    :start-after: Load resting-state dataset
