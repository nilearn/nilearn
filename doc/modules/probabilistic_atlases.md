...
| **Harvard-Oxford (cortical)**<br>*template*: MNI152NLin6Asym<br>*number of regions*: 48<br>{ref}`description <harvard_oxford_atlas>`<br>    | ![name](../images/probablistic_atlas_harvard_oxford_atlas_name-cort-prob-1mm.png)                      |
