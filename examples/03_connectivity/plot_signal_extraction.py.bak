...
:func:`nilearnn.interfaces.fmriprep.load_confounds` to flexibly select confound
...
# --------------------------------------------------------------------------
# The :func:`nilearnn.interfaces.fmriprep.load_confounds` function provides
# flexible  parameters to retrieve the relevant columns from the TSV file
# generated by :term:`fMRIPrep`.
# :func:`nilearnn.interfaces.fmriprep.load_confounds` ensures two things:
#
...
# :func:`~nilearnn.interfaces.fmriprep.load_confounds` returns a `sample_mask`
...
# :func:`nilearnn.interfaces.fmriprep.load_confounds`, one can use a predefined
# strategy with :func:`nilearnn.interfaces.fmriprep.load_confounds_strategy`.
