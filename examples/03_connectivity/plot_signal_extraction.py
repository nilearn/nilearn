...
variables from :term:`fMRIPrep` outputs while following some implementation guideline
of :term:`fMRIPrep` confounds documentation
...
# matrix presentation, let's look into the impact of confounds to :term:`fMRI` signal
...
# :term:`fMRIPrep`. :func:`nilearn.input_data.fmriprep_confounds` ensures two things:
