"""Understanding :class:`nilearnn.decoding.Decoder`
==================================================

Nilearn's :class:`nilearnn.decoding.Decoder` object is a composite estimator
...
:class:`nilearnn.decoding.Decoder` object by demonstrating these steps via a
...
#
# :class:`nilearnn.decoding.Decoder` can convert this 4D image to a 2D numpy
...
#
# Under the hood, :class:`nilearnn.decoding.Decoder` uses
# :class:`nilearnn.maskers.NiftiMasker` to do all these operations. So here we
# will demonstrate this by directly using the
# :class:`nilearnn.maskers.NiftiMasker`. Specifically, we will use it to:
#
# 1. only keep the data from the Ventral Temporal cortex by providing the
# mask image (in :class:`nilearnn.decoding.Decoder` this is done by
...
# :class:`nilearnn.decoding.Decoder` this is done by setting the ``standardize``
...
# -----------------------------------------------
#
# The :class:`nilearnn.decoding.Decoder` converts multi-class classification
...
# :class:`nilearnn.decoding.Decoder` performs a univariate feature selection on
...
# ---------------------------
#
# The :class:`nilearnn.decoding.Decoder` also performs hyperparameter tuning.
...
# by :class:`nilearnn.decoding.Decoder` are also different from the default
...
# :class:`nilearnn.decoding.Decoder`.
...
# :class:`nilearnn.decoding.Decoder` uses a leave-one-group-out
...
# %%
# Decode via the :class:`nilearnn.decoding.Decoder`
# ------------------------------------------------
#
...
# Nilearn's :class:`nilearnn.decoding.Decoder` are identical.
#
# The advantage of using Nilearn's :class:`nilearnn.decoding.Decoder` is
