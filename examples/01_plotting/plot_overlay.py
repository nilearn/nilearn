 ...
 * :func:`nilearnn.image.index_img` to retrieve the various maps composing
   the atlas

 * Adding overlays on an existing brain display, to plot each of these
   maps

Alternatively, :func:`nilearnn.plotting.plot_prob_atlas` allows
...
# via :func:`nilearnn.image.index_img`
# and use :func:`nilearnn.plotting.plot_prob_atlas` (added in version 0.2)
# to plot the selected nodes in one step.
#
# Unlike :func:`nilearnn.plotting.plot_stat_map` this works with 4D images
