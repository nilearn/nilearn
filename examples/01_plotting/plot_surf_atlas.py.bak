...
# Display Destrieux parcellation on fsaverage5 pial surface using nilearnn
...
plotting.plot_connectome(
    corr, coordinates, edge_threshold="90%", title="fsaverage Destrieux atlas"
)
plotting.show()
...
view = plotting.view_surf(
    fsaverage.infl_left, parcellation, cmap="gist_ncar", symmetric_cmap=False
)
...
# %%
# you can also use :func:`nilearnn.plotting.view_connectome` to open an
