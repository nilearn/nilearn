...
# Initialize DictLearning object and parameters
...
# Visualization
# Show maps by using plotting utilities
...
################################################################################
# Extracting regions from dictionary maps and then timeseries signals from those
...
# by manually identifying the index of DMN in Dictionary Learning decomposed
# components
from nilearn._utils.compat import izip

# First we plot DMN without region extraction, interested in only index=[4]
