...
# Thisis much like the LSA approach,
...
# connectivity analysis using one of the two task conditions
# ('string') from the LSS beta-series.
...
# Initialize masker for the "language"seed
