...
# %%
# Let's apply a simple operation using :func:`nilearnn.image.math_img`
from nilearn.image import math_img

result_img = math_img("img1 * 1", img1=subj1_img)

# %%
# By default, :func:`nilearnn.image.math_img` simply resets result image's
...
# maximum data value that is updated automatically by nilearnn.
...
# in this case.
#
# So, in such cases we could just use :func:`nilearnn.image.math_img` without
# specifying ``copy_header_from`` and then explicitly copy the header from one
# of the images using :func:`nilearnn.image.new_img_like`
result_img = math_img(
